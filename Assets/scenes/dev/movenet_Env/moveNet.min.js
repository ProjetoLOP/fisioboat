...
function evaluateTrend() {
  // Se estiver em pose de descanso (em pé)
  ...
  // Só analisa se temos histórico suficiente
  ...
  // Subindo (profundidade diminuindo) após ter descido
  else if (slope < -TREND_SLOPE_THRESHOLD && movementState === "performing") {
